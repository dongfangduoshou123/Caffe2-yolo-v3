...
class UpsampleOp final : public Operator<Context> {
 public:
...
template <typename T, class Context>
class UpsampleGradientOp final : public Operator<Context> {
 public:
  UpsampleGradientOp(const OperatorDef& def, Workspace* ws)
